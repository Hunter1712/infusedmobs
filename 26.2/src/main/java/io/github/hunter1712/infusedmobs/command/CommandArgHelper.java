...
/**
 * Version shim for command argument types (26.2 — Identifier).
 * 1.21.1 uses {@code ResourceLocation} where 26.2 uses {@code Identifier};
 * common command code talks only to this shim plus {@code String}.
 */
